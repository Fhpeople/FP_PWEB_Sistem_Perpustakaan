                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5 mb-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Login Sistem Perpustakaan</h3></div>
                                    <div class="card-body">
                                        <?php
                                            if (isset($_POST['login'])) {
                                                ...
                                                if ($cek > 0) {
                                                    $_SESSION['pengguna'] = mysqli_fetch_array($data);
                                        ...
                                        <form method="post">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputEmail" type="email" name="email" placeholder="name@example.com" />
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="register.php">Don't have an account? Register here!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
