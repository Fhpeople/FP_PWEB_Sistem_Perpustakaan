...
<div class="card">
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <a href="?page=kategori_tambah" class="btn btn-primary mb-2">+ Tambah Kategori</a>
                        ...
                        while($data = mysqli_fetch_array($query)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a onclick="return confirm('Apakah anda yakin ingin menghapus kategori?');" href="?page=kategori_hapus&&id=<?php echo $data['id_kategori']; ?>" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
                            <?php
                        }
